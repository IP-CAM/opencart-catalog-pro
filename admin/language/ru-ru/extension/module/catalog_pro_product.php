...
$_['validate']              = array (
    ...
    'minimum.min' => 'Значение поля "Минимальное количество" должно быть не менее {{ limit }}',
    ...
    'sort_order.min' => 'Значение поля "Вес" должно быть не менее {{ limit }}',
    'sort_order.invalid' => 'Поле "Вес" должно быть числом',
);
